...
API_ID = int(environ.get('API_ID', '22475424'))
API_HASH = environ.get('API_HASH', '5971f827128727176690c7f302ea46e5')
BOT_TOKEN = environ.get('BOT_TOKEN', "7900225411:AAEXrsdzRiiL3vK4W9J6ZTfZPy8rbTyVOAE")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6795403349').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002473893264').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002322657539'))  # Log channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002322657539'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002322657539'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002323326034')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002462246320').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002419200539')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002253497086')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002146212748 ').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('AUTH_CHANNEL', '-1002323326034').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://harshumanal:harshumanal@cluster0.jxxdp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://d3242dy5ot:JkRUwWnb5hygsjiI@cluster0.xrppp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Hm_movie_search_143')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+cw6l3l1rVxo5MGQ1')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/itsharshu_143')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+cw6l3l1rVxo5MGQ1')
OWNERID = int(os.environ.get('OWNERID', '6795403349'))  # Replace with the actual admin ID
